...
@interface Rnsolus ()<SOLUSIntegrationLibraryDelegate,FaceTecFaceScanProcessorDelegate,SolusDlockDelegate>{
...
RCT_EXPORT_METHOD(Init:(NSString *)DeviceKeyIdentifier FaceScanEncryptionKey:(NSString *)FaceScanEncryptionKey)
{
  {
...
RCT_EXPORT_METHOD(Enroll:(NSString *)name pwd:(NSString *)password ){
  self.currentUsername = name;
  self.currentPassword = password;
  [self EnrollProcess];
}

RCT_EXPORT_METHOD(DeEnroll:(NSString *)name pwd:(NSString *)password ){
  self.currentUsername = name;
  self.currentPassword = password;
  [self DeEnrollProcess];
}

RCT_EXPORT_METHOD(Authenticate:(NSString *)name pwd:(NSString *)password ){
  self.currentUsername = name;
  self.currentPassword = password;
  [self SignInProcess];
}
