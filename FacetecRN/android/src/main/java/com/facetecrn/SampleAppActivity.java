...
import com.facetecrn.databinding.ActivityMainBinding;
...
public class SampleAppActivity extends ReactActivity {
      ...
      public void run() {
        getSessionToken(new SessionTokenCallback() {
          ...
          public void onSessionTokenReceived(String sessionToken) {
            ...
            FacetecRnModule.isEnrolled = true;
            FacetecRnModule.id = latestExternalDatabaseRefID;
  ...
  public void onAuthenticateUserPressed(View v) {
    isSessionPreparingToLaunch = true;
    latestExternalDatabaseRefID = getIntent().getStringExtra("id");
